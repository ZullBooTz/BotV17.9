...
global.OpenAIKey = "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" //login to https://platform.openai.com/account/api-keys to get apikey
...
global.APIKeys = {
   'https://api.zeeoneofc.my.id': 'zE6P4zv9yciV4S5', // 👉 login https://api.zeeoneofc.my.id to get apikey
}
global.sewabotnya = `
...
// Other
// Other
global.botname = "Latina - Mdོ" //namabot kalian
global.ownername = "ᴹᴿ᭄ ༄ᶜZull - Modz☆࿐ ×፝֟͜×" //nama kalian
...
global.email = "zullbootz1@gmail.com" //bebas
global.region = "Indonesia" //bebas
global.timezone = 'Asia/Jakarta' //  timezone wib
global.premium_fitur = ["ai", "openai", "chatgpt", "nfsw", "NFSW"] //tambahin aja sendiri, soalnya gk semua org mau fiturnya premium jadi gw buat kyk gini aja, biar bisa custom fitur mana aja yang bakal di jadiin premium
global.badword_list = ["asu", "anjir", "Kntl", "Bgst", "Bangsat", "Kontol", "ajg", "Anjing", "tolol", "goblok", "pantek", "memek", "mmk", "pepek"] //tambahin sendiri kata² nya, gunakan huruf kecil
global.premium = ['6289603792741'] //premium user
global.owner = ["6289603792741", "6289525772874"] //ganti agar fitur owner bisa di gunakan
